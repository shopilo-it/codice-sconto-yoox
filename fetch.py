...
Sursa: https://shopilo.it/negozi/yoox.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/yoox.com"
STORE_NAME = "YOOX"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per YOOX da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-yoox)"
    }
    try:
